...
const Dock = () => {
  return (
    <motion.div 
      className="fixed left-4 top-1/2 -translate-y-1/2 z-50 bg-background-primary/80 backdrop-blur-xl border border-background-tertiary/50 rounded-2xl shadow-2xl shadow-black/20 p-2 flex flex-col space-y-2"
